...
const featureFields = {
  ...
  description_ar: z.string().max(500, "description_ar is too long").nullable().optional(),

  type: FeatureTypeEnum,

  unit: z.string().max(50, "unit cannot exceed 50 characters").nullable().optional(),
  unit_ar: z.string().max(50, "unit_ar cannot exceed 50 characters").nullable().optional(),
