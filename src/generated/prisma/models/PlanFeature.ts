...
export type PlanFeatureWhereUniqueInput = Prisma.AtLeast<{
  plan_id_feature_id?: Prisma.PlanFeaturePlan_idFeature_idCompoundUniqueInput
  AND?: Prisma.PlanFeatureWhereInput | Prisma.PlanFeatureWhereInput[]
  OR?: Prisma.PlanFeatureWhereInput[]
  NOT?: Prisma.PlanFeatureWhereInput | Prisma.PlanFeatureWhereInput[]
  plan_id?: Prisma.UuidFilter<"PlanFeature"> | string
...
export type PlanFeaturePlan_idFeature_idCompoundUniqueInput = {
  plan_id: string
  feature_id: string
}
...
export interface PlanFeatureDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const planFeatureWithPlan_idOnly = await prisma.planFeature.findMany({ select: { plan_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PlanFeatures and only return the `plan_id`
   * const planFeatureWithPlan_idOnly = await prisma.planFeature.createManyAndReturn({
   *   select: { plan_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PlanFeatures and only return the `plan_id`
   * const planFeatureWithPlan_idOnly = await prisma.planFeature.updateManyAndReturn({
   *   select: { plan_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
