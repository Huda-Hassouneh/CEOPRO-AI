...
export function createPreviewData() {
  ...
  return { companies, users, subscriptions, 'admin-team': [
    { id: 'preview-admin', name: 'Alex Rowan', email: 'alex@example.test', role: 'SUPER_ADMIN', status: 'active', createdAt: '2026-04-01T09:00:00Z' },
    { id: 'admin-2', name: 'Sam Ellis', email: 'sam@example.test', role: 'ADMIN', status: 'active', createdAt: '2026-05-02T09:00:00Z' },
    { id: 'admin-3', name: 'Robin Sage', email: 'robin@example.test', role: 'EDITOR', status: 'active', createdAt: '2026-06-03T09:00:00Z' },
    { id: 'admin-4', name: '', email: 'avery@example.test', role: 'VIEWER', status: 'pending', createdAt: '2026-09-12T09:00:00Z' },
